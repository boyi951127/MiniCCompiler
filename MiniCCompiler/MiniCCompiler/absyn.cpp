...
A_exp A_IfExp(A_pos pos, A_exp test, A_exp elsee)
{
	A_exp p = (A_exp)checked_malloc(sizeof(*p));
	p->kind = A_exp_::A_ifExp;
	p->pos = pos;
	p->u.iff.test = test;
	p->u.iff.elsee = elsee;
	return p;
